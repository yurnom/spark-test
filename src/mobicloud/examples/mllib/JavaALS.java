...
package mobicloud.examples.mllib;
...
public final class JavaALS {
  ...
  public static void main(String[] args) {
    ...
    MatrixFactorizationModel model = ALS.train(ratings.rdd(), rank, iterations, 0.01, blocks);
	  ...
	  System.out.println(model.predict(4,3));

//	  ((JavaRDD)model.userFeatures().toJavaRDD()).map(new FeaturesToString()).saveAsTextFile(
//        outputDir + "/userFeatures");
//	  ((JavaRDD)model.productFeatures().toJavaRDD()).map(new FeaturesToString()).saveAsTextFile(
